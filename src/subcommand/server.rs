...
mod tests {
  ...
  fn search_for_blockhash_returns_block() {
    TestServer::new().assert_redirect(
      "/search/00000709e30d30e9d5024bad04a2572a586aa501cf7d83b332acc1aaae4feff7",
      "/block/00000709e30d30e9d5024bad04a2572a586aa501cf7d83b332acc1aaae4feff7",
    );
  }
  ...
  fn block_info() {
    ...
    pretty_assert_eq!(
      ...
      api::BlockInfo {
        ...
        confirmations: 0,
        difficulty: 0.0,
        hash: "00000709e30d30e9d5024bad04a2572a586aa501cf7d83b332acc1aaae4feff7"
          .parse()
          .unwrap(),
